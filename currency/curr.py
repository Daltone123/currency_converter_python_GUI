...
label3= tk.Label(window,text="Preferred currency:", font="Times 16 bold").place(x=15, y=200)
entry3 = tk.Entry(window)
button = tk.Button(text="Convert", font="Times 16 bold", command=convert_button).place(x=220, y = 250)
